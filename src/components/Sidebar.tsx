          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex flex-col space-y-4">
              <button
                ...
                className="flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 px-6 py-2 hover:bg-gray-100 rounded-lg"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 text-sm text-red-600 hover:text-red-700 px-6 py-2 hover:bg-red-50 rounded-lg"
              >
